import { Component, OnInit, ViewChild, afterNextRender, afterRender, ElementRef, inject, DestroyRef, ChangeDetectionStrategy, ChangeDetectorRef } from "@angular/core";
...
export class ListrecordsComponent implements OnInit {
  ...
  ngOnDestroy(): void {
    ...
    if (this.recordsContainer) {
      this.scrollPosition = this.recordsContainer.nativeElement.scrollTop;
    }
  }
  ...
  private restoreScrollPosition(): void {
    if (this.scrollPosition > 0 && this.recordsContainer) {
      this.recordsContainer.nativeElement.scrollTop = this.scrollPosition;
    }
  }
