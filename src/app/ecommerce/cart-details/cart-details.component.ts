import { Component, OnInit, OnDestroy, afterNextRender, afterRender, ElementRef, ViewChild, ChangeDetectionStrategy, ChangeDetectorRef, inject } from '@angular/core';
...
export class CartDetailsComponent implements OnInit, OnDestroy {
  ...
  private setupCartInteractions(): void {
  ...
  private updateCartVisuals(): void {
    // Update styles based on the current state
