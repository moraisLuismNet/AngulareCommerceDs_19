import { Component, OnInit, afterNextRender, afterRender, ElementRef, ViewChild, inject, DestroyRef, ChangeDetectionStrategy, ChangeDetectorRef } from '@angular/core';
...
export class UsersComponent implements OnInit {
  ...
  private restoreScrollPosition(): void {
    if (this.lastScrollPosition > 0 && this.usersTable) {
      this.usersTable.nativeElement.scrollTop = this.lastScrollPosition;
    }
  }
